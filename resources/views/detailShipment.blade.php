        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <address>
                            Nama Staf         : {{$shipment->nama_lengkap}} <br>
                            Nomor Telepon Staf : {{$shipment->notelp}}<br>
                            <h5>Invoice</h5>
                            <p>Invoice : {{$shipment->invoice_id}}</p>
                            <p>Tanggal Pengiriman: {{$shipment->created_at->format('F j, Y')}}</p>
                        </address>
                    </div>
