              ...
              <div class="card-body">
                <form role="form" class="text-start" method="post" action="/daftarAdmin">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2"><i class="fa fa-spinner"></i> Daftar</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                    Sudah Memiliki Akun?
                    <a href="/signin" class="text-primary text-gradient font-weight-bold">Login</a>
                  </p>
                </form>
              </div>
            </div>
